export const journeyData = {
  eyebrow: "Trajetória de impacto",
  title: "Uma trajetória construída com tecnologia, liderança e impacto.",
  description:
  ...
  items: [
    ...
    {
      period: "2019–2025",
      title: "Liderança em dados e grandes projetos",
      organization: "Marketdata",
      description:
        "Liderei equipes e projetos estratégicos de Engenharia de Dados e Analytics, conectando arquitetura, governança e resultados de negócio.",
